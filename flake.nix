  ...
  outputs = inputs @ {
    ...
    configuration = {pkgs, ...}: {
      ...
      homebrew = {
        ...
        taps = [];
        brews = ["gnu-sed"];
        casks = ["tailscale" "gcloud-cli" "bitwarden" "slack" "spotify" "wezterm" "arc" "sublime-text" "orbstack" "google-chrome" "chatgpt" "mimestream" "zed" "android-studio" "tableplus" "transmit" "microsoft-teams" "ghostty" "poedit" "flutter" "claude"];
      };
