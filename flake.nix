  ...
  outputs = inputs @ {
    ...
    configuration = {pkgs, ...}: {
      ...
      homebrew = {
        ...
        taps = [];
        brews = ["gnu-sed"];
        casks = ["slack" "spotify" "wezterm" "arc" "sublime-text" "orbstack" "google-chrome" "chatgpt" "mimestream" "zed" "flutter" "android-studio" "tableplus" "transmit" "microsoft-teams" "ghostty" "poedit" "gitbutler"];
      };
